...
keywords:
  ...
  - Streaming
summary: >-
  本文围绕渲染模式：CSR / SSR / SSG / ISR / Streaming
  SSR展开，重点说明深入对比客户端渲染、服务端渲染、静态生成、增量静态再生和流式渲染的技术原理、适用场景与性能权衡，并补充核心机制、代码示例、工程实践、常见误区和参考资料。
learningGoals:
  - 理解渲染模式：CSR / SSR / SSG / ISR / Streaming SSR的核心概念、问题背景和适用边界。
  - 掌握渲染模式：CSR / SSR / SSG / ISR / Streaming SSR在真实前端工程中的典型用法和验证方式。
  - 能够识别渲染模式：CSR / SSR / SSG / ISR / Streaming SSR相关的常见误区，并选择合适的优化或治理策略。
prerequisites:
...
- 本文围绕渲染模式：CSR / SSR / SSG / ISR / Streaming SSR展开，重点说明深入对比客户端渲染、服务端渲染、静态生成、增量静态再生和流式渲染的技术原理、适用场景与性能权衡，并补充核心机制、代码示例、工程实践、常见误区和参考资料。
- 阅读重点是把「渲染模式：CSR / SSR / SSG / ISR / Streaming SSR」放回 第 21 章 加载性能优化 的知识链路中理解，而不是只记忆孤立定义。
...
| 概念 | 说明 |
|---|---|
| CSR | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| SSR | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| SSG | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| ISR | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| Streaming SSR | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
...
在真实项目中落地渲染模式：CSR / SSR / SSG / ISR / Streaming SSR时，可以按以下顺序推进：
...
| 维度 | 关注点 | 判断标准 |
|---|---|---|
| 概念理解 | 渲染模式：CSR / SSR / SSG / ISR / Streaming SSR的定义、边界和相邻概念。 | 能用自己的话解释，并指出至少一个反例。 |
...
<Quiz
  question={"学习渲染模式：CSR / SSR / SSG / ISR / Streaming SSR时，最能体现工程化理解的是哪一项？"}
  options={[
    "只记住一个简短定义",
  ...
  correctIndex={1}
  explanation={"工程化理解不止停留在概念定义，还要能说明适用边界、验证方式和风险控制。这样才能把渲染模式：CSR / SSR / SSG / ISR / Streaming SSR从知识点转化为可落地的工程判断。"}
/>
