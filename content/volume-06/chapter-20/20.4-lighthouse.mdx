...
keywords:
  ...
  - Insights
summary: >-
  本文围绕性能评分工具：Lighthouse / PageSpeed Insights / WebPageTest展开，重点说明深入对比
  Lighthouse、PageSpeed Insights、WebPageTest
  三大性能工具的原理、使用方法和实战技巧，并补充核心机制、代码示例、工程实践、常见误区和参考资料。
learningGoals:
  - 理解性能评分工具：Lighthouse / PageSpeed Insights / WebPageTest的核心概念、问题背景和适用边界。
  - 掌握性能评分工具：Lighthouse / PageSpeed Insights / WebPageTest在真实前端工程中的典型用法和验证方式。
  - >-
    能够识别性能评分工具：Lighthouse / PageSpeed Insights /
    WebPageTest相关的常见误区，并选择合适的优化或治理策略。
prerequisites:
...
- 本文围绕性能评分工具：Lighthouse / PageSpeed Insights / WebPageTest展开，重点说明深入对比 Lighthouse、PageSpeed Insights、WebPageTest 三大性能工具的原理、使用方法和实战技巧，并补充核心机制、代码示例、工程实践、常见误区和参考资料。
- 阅读重点是把「性能评分工具：Lighthouse / PageSpeed Insights / WebPageTest」放回 第 20 章 Web 性能指标体系 的知识链路中理解，而不是只记忆孤立定义。
- 工程实践中需要同时关注 Lighthouse、PageSpeed、WebPageTest、性能测试 等关键因素，并用可观察的指标或测试结果验证判断。
...
| 概念 | 说明 |
|---|---|
| Lighthouse | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| PageSpeed | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| WebPageTest | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| 性能测试 | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| CI/CD | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
...
在真实项目中落地性能评分工具：Lighthouse / PageSpeed Insights / WebPageTest时，可以按以下顺序推进：
...
| 维度 | 关注点 | 判断标准 |
|---|---|---|
| 概念理解 | 性能评分工具：Lighthouse / PageSpeed Insights / WebPageTest的定义、边界和相邻概念。 | 能用自己的话解释，并指出至少一个反例。 |
...
<Quiz
  question={"学习性能评分工具：Lighthouse / PageSpeed Insights / WebPageTest时，最能体现工程化理解的是哪一项？"}
  options={[
    "只记住一个简短定义",
  ...
  correctIndex={1}
  explanation={"工程化理解不止停留在概念定义，还要能说明适用边界、验证方式和风险控制。这样才能把性能评分工具：Lighthouse / PageSpeed Insights / WebPageTest从知识点转化为可落地的工程判断。"}
/>
