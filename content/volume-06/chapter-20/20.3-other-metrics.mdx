...
keywords:
  ...
  - 其他关键指标
summary: >-
  本文围绕其他关键指标：FCP / TTFB / TBT / TTI / SI展开，重点说明全面解析 FCP、TTFB、TBT、TTI、SI
  等辅助性能指标的原理、测量方法与实战应用，并补充核心机制、代码示例、工程实践、常见误区和参考资料。
learningGoals:
  - 理解其他关键指标：FCP / TTFB / TBT / TTI / SI的核心概念、问题背景和适用边界。
  - 掌握其他关键指标：FCP / TTFB / TBT / TTI / SI在真实前端工程中的典型用法和验证方式。
  - 能够识别其他关键指标：FCP / TTFB / TBT / TTI / SI相关的常见误区，并选择合适的优化或治理策略。
prerequisites:
  - title: 20.1 RAIL 模型
...
related:
  ...
  - title: 21.2 代码优化：Tree Shaking / Code Splitting / 懒加载
    slug: volume-06/chapter-21/21.2-code-optimization
...
- 本文围绕其他关键指标：FCP / TTFB / TBT / TTI / SI展开，重点说明全面解析 FCP、TTFB、TBT、TTI、SI 等辅助性能指标的原理、测量方法与实战应用，并补充核心机制、代码示例、工程实践、常见误区和参考资料。
- 阅读重点是把「其他关键指标：FCP / TTFB / TBT / TTI / SI」放回 第 20 章 Web 性能指标体系 的知识链路中理解，而不是只记忆孤立定义。
- 工程实践中需要同时关注 FCP、TTFB、TBT、TTI 等关键因素，并用可观察的指标或测试结果验证判断。
...
| 概念 | 说明 |
|---|---|
| FCP | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| TTFB | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| TBT | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| TTI | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
| SI | 需要明确它的定义、适用范围、与相邻概念的区别，以及在代码中的可观察表现。 |
...
在真实项目中落地其他关键指标：FCP / TTFB / TBT / TTI / SI时，可以按以下顺序推进：
...
| 维度 | 关注点 | 判断标准 |
|---|---|---|
| 概念理解 | 其他关键指标：FCP / TTFB / TBT / TTI / SI的定义、边界和相邻概念。 | 能用自己的话解释，并指出至少一个反例。 |
...
<Quiz
  question={"学习其他关键指标：FCP / TTFB / TBT / TTI / SI时，最能体现工程化理解的是哪一项？"}
  options={[
    "只记住一个简短定义",
  ...
  correctIndex={1}
  explanation={"工程化理解不止停留在概念定义，还要能说明适用边界、验证方式和风险控制。这样才能把其他关键指标：FCP / TTFB / TBT / TTI / SI从知识点转化为可落地的工程判断。"}
/>
